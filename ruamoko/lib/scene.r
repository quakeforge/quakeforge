...
int Scene_Entqueue (scene_t scene, string entqueue_name) = #0;
...
void Entity_SetAnimstate (entity_t ent, animstate_t anim) = #0;
...
bool qfa_extract_root_motion (model_t model) = #0;
...
void qfa_set_anim_clip (animstate_t anim, uint slot, cliphandle_t clip) = #0;
