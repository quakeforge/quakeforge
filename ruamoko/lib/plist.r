...
plitem_t *PL_JSON (string str) = #0;
plitem_t *PL_JSONFromFile (QFile file) = #0;
string PL_WriteJSON (plitem_t *pl) = #0;
pltype_t PL_Type (plitem_t *str) = #0;
int PL_Line (plitem_t *str) = #0;
string PL_String (plitem_t *str) = #0;
double PL_Number (plitem_t *str) = #0;
bool PL_Bool (plitem_t *str) = #0;
...
plitem_t *PL_NewNumber (double val) = #0;
plitem_t *PL_NewBool (bool val) = #0;
plitem_t *PL_NewNull (void) = #0;
