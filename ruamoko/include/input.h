...
string *IN_ListButtons ();
string *IN_ListAxes ();
in_button_t IN_GetButton (string name);
in_axis_t IN_GetAxis (string name);
string IN_GetButtonDescription (string name);
string IN_GetAxisDescription (string name);
