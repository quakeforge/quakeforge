...
string qdb_event_name (int event) = #0;
void qdb_load_progs (string fname) = #0;
void qdb_set_trace (qdb_target_t target, int state) = #0;
void qdb_set_stepping (qdb_target_t target, int state) = #0;
...
void qdb_until_new_line (qdb_target_t target) = #0;
void qdb_until_function (qdb_target_t target, unsigned func) = #0;
void qdb_until_depth (qdb_target_t target, int depth) = #0;
int qdb_terminate (qdb_target_t target) = #0;
void qdb_delete_target (qdb_target_t target) = #0;
