...
void qdb_set_stepping (qdb_target_t target, int state);
...
void qdb_until_new_line (qdb_target_t target);
void qdb_until_function (qdb_target_t target, unsigned func);
void qdb_until_depth (qdb_target_t target, int depth);
