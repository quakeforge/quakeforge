...
D_Init_Cvars (void)
{
	d_subdiv16 = Cvar_Get ("d_subdiv16", "1", CVAR_NONE, 0, "Set to enable extreme perspective correction");
	d_mipcap = Cvar_Get ("d_mipcap", "0", CVAR_NONE, 0, "Detail level. 0 is highest, 3 is lowest.");
