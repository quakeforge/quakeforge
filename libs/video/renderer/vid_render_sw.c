...
vid_render_funcs_t sw_vid_render_funcs = {
	...
	.draw = {
		.CharBuffer        = sw_Draw_CharBuffer,
		.Character         = Draw_Character,
		.String            = Draw_String,
		.nString           = Draw_nString,
		.AltString         = Draw_AltString,
		.ConsoleBackground = Draw_ConsoleBackground,
		.Crosshair         = Draw_Crosshair,
		.CrosshairAt       = Draw_CrosshairAt,
		.TileClear         = Draw_TileClear,
		.Fill              = Draw_Fill,
		.Line              = Draw_Line,
		.TextBox           = Draw_TextBox,
		.FadeScreen        = Draw_FadeScreen,
		.BlendScreen       = Draw_BlendScreen,
		.CachePic          = Draw_CachePic,
		.UncachePic        = Draw_UncachePic,
		.MakePic           = Draw_MakePic,
		.DestroyPic        = Draw_DestroyPic,
		.PicFromWad        = Draw_PicFromWad,
		.Pic               = Draw_Pic,
		.FitPic            = Draw_FitPic,
		.Picf              = Draw_Picf,
		.SubPic            = Draw_SubPic,
		.AddFont           = Draw_AddFont,
		.Glyph             = Draw_Glyph,
		.SetClip           = Draw_SetClip,
		.ResetClip         = Draw_ResetClip,
	},
