...
vid_render_funcs_t glsl_vid_render_funcs = {
	...
	.draw = {
		.CharBuffer        = glsl_Draw_CharBuffer,
		.SetScale          = glsl_Draw_SetScale,
		.Character         = glsl_Draw_Character,
		.String            = glsl_Draw_String,
		.nString           = glsl_Draw_nString,
		.AltString         = glsl_Draw_AltString,
		.ConsoleBackground = glsl_Draw_ConsoleBackground,
		.Crosshair         = glsl_Draw_Crosshair,
		.CrosshairAt       = glsl_Draw_CrosshairAt,
		.TileClear         = glsl_Draw_TileClear,
		.Fill              = glsl_Draw_Fill,
		.Line              = glsl_Draw_Line,
		.TextBox           = glsl_Draw_TextBox,
		.FadeScreen        = glsl_Draw_FadeScreen,
		.BlendScreen       = glsl_Draw_BlendScreen,
		.CachePic          = glsl_Draw_CachePic,
		.UncachePic        = glsl_Draw_UncachePic,
		.MakePic           = glsl_Draw_MakePic,
		.DestroyPic        = glsl_Draw_DestroyPic,
		.PicFromWad        = glsl_Draw_PicFromWad,
		.Pic               = glsl_Draw_Pic,
		.FitPic            = glsl_Draw_FitPic,
		.Picf              = glsl_Draw_Picf,
		.SubPic            = glsl_Draw_SubPic,
		.AddFont           = glsl_Draw_AddFont,
		.Glyph             = glsl_Draw_Glyph,
		.SetClip           = glsl_Draw_SetClip,
		.ResetClip         = glsl_Draw_ResetClip,
	},
