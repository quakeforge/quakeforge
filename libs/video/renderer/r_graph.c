...
R_TimeGraph (view_pos_t abs, view_pos_t len)
{
	...
	r_funcs->draw.Line (abs.x, abs.y, abs.x + MAX_TIMINGS, abs.y, 0x0f);
	r_funcs->draw.Line (abs.x, abs.y - 10, abs.x + MAX_TIMINGS, abs.y - 10, 0x3f);
	r_funcs->draw.Line (abs.x, abs.y - 20, abs.x + MAX_TIMINGS, abs.y - 20, 0x3f);
	r_funcs->draw.Line (abs.x, abs.y - 25, abs.x + MAX_TIMINGS, abs.y - 25, 0x3f);
	r_funcs->draw.Line (abs.x, abs.y - 33, abs.x + MAX_TIMINGS, abs.y - 33, 0x3f);
	r_funcs->draw.Line (abs.x, abs.y - 50, abs.x + MAX_TIMINGS, abs.y - 50, 0x3f);
	r_funcs->draw.Line (abs.x, abs.y - 100, abs.x + MAX_TIMINGS, abs.y - 100, 0x3f);
