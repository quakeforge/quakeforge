...
vid_render_funcs_t gl_vid_render_funcs = {
	...
	.draw = {
		.CharBuffer        = gl_Draw_CharBuffer,
		.SetScale          = gl_Draw_SetScale,
		.Character         = gl_Draw_Character,
		.String            = gl_Draw_String,
		.nString           = gl_Draw_nString,
		.AltString         = gl_Draw_AltString,
		.ConsoleBackground = gl_Draw_ConsoleBackground,
		.Crosshair         = gl_Draw_Crosshair,
		.CrosshairAt       = gl_Draw_CrosshairAt,
		.TileClear         = gl_Draw_TileClear,
		.Fill              = gl_Draw_Fill,
		.Line              = gl_Draw_Line,
		.TextBox           = gl_Draw_TextBox,
		.FadeScreen        = gl_Draw_FadeScreen,
		.BlendScreen       = gl_Draw_BlendScreen,
		.CachePic          = gl_Draw_CachePic,
		.UncachePic        = gl_Draw_UncachePic,
		.MakePic           = gl_Draw_MakePic,
		.DestroyPic        = gl_Draw_DestroyPic,
		.PicFromWad        = gl_Draw_PicFromWad,
		.Pic               = gl_Draw_Pic,
		.FitPic            = gl_Draw_FitPic,
		.Picf              = gl_Draw_Picf,
		.SubPic            = gl_Draw_SubPic,
		.AddFont           = gl_Draw_AddFont,
		.Glyph             = gl_Draw_Glyph,
		.SetClip           = gl_Draw_SetClip,
		.ResetClip         = gl_Draw_ResetClip,
	},
