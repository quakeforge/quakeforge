...
struct symbol_s *get_struct_field (const type_t *t1, const expr_t *e1,
								   const expr_t *e2);
const expr_t *struct_field_expr (const expr_t *obj, const char *field_name);
...
const expr_t *array_property (const type_t *type, const attribute_t *attr,
							  rua_ctx_t *ctx);
...
const expr_t *value_cast_expr (const type_t *t, const expr_t *e);
...
const expr_t *offset_cast (const type_t *type, const expr_t *expr, int offset);
