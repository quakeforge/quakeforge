...
EX_EXPR(functor)	///< callable object (::ex_functor_t)
...
EX_EXPR(offset)		///< struct member offset (::ex_offset_t)
...
EX_EXPR(decl)		///< delcaration expression (::ex_decl_t)
EX_EXPR(visibility)	///< delcaration expression (::ex_vis_t)
