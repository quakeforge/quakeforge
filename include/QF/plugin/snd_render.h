...
typedef struct snd_render_funcs_s {
	...
	bool      (*channel_set_sfx) (struct channel_s *chan, struct sfx_s *sfx);
	void      (*channel_set_paused) (struct channel_s *chan, bool paused);
	void      (*channel_set_looping) (struct channel_s *chan, bool looping);
