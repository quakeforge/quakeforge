...
void gl_R_Init (memhunk_t *hunk, struct plitem_s *config);
void glsl_R_Init (memhunk_t *hunk, struct plitem_s *config);
void glsl_R_Shutdown (void);
void sw_R_Init (memhunk_t *hunk, struct plitem_s *config);
